<x-app-layout>
    <div class="max-w-5xl mx-auto py-12">
        ...
        <h1 class="text-lg font-bold mb-4 text-gray-900 text-center p-2">Admin Dashboard</h1>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if(!$listing->is_verified)
                                    <form action="{{ route('listings.verify', $listing->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition duration-300">Verify</button>
                                    </form>
                                @endif
                            </td>
                        </tr>
