...
<style>
    ...
    /* If sidebar is closed, reduce the size */
    .sidebar-closed .sidebar {
        width: 60px;
        /* Or 0px, depending on how much space you want */
    }

    /* Shift content to the right when sidebar is opened */
    .sidebar-open .main-content {
        margin-left: 250px;
        /* Same width as the sidebar */
    }

    /* Dark blue section adjustment */
    .main-content {
        background-color: #1E3A8A;
        /* Dark blue */
        padding: 20px;
        width: calc(100% - 250px);
        /* Sidebar width subtracted */
    }
</style>
